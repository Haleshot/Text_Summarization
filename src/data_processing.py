...
class Ui_Data_processing(QDialog):
    ...
    def Text_Preprocessing_Data(self):
        global vocab_to_int, sorted_texts, batch_size, sorted_summaries, train_op, cost, input_data, lr, summary_length, keep_prob, train_graph
        ...
        self.word_embedding_matrix = np.zeros((nb_words, embedding_dim), dtype=np.float32)
        ...
        print(len(self.word_embedding_matrix))
    ...
    #                     self.Training_Model_Data.get_batches(sorted_summaries, sorted_texts, batch_size)):
